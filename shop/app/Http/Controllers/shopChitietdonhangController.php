...
class shopChitietdonhangController extends Controller
{
    public function getDanhsach(){
    	$ctdh = shop_chitietdonhang::all();
    	return view('admin.donhang.chitiet',['chitietdonhang'=>$ctdh]);
    }
    public function getSua($ctdh_ma){
