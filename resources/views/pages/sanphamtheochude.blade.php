            ...
            <!-- Sidebar end=============================================== -->
                <div class="span9">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">{{$tenchude->cd_ten}}</li>
                    </ul>
                    <h3> Sản Phẩm <small class="pull-right"> {{count($sanphamtheochude)}} Sản Phẩm</small></h3>
                    ...
                    <div class="pagination">
                        {{ $sanphamtheochude->appends(['sort' => 'votes'])->links() }}
                    </div>
