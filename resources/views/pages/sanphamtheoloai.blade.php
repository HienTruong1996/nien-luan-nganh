            ...
            <!-- Sidebar end=============================================== -->
                <div class="span9">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">{{$tenloai->l_ten}}</li>
                    </ul>
                    <h3> Sản Phẩm <small class="pull-right"> {{count($sanphamtheoloai)}} Sản Phẩm</small></h3>
                    ...
                    <div class="pagination">
                        {{ $sanphamtheoloai->appends(['sort' => 'votes'])->links() }}
                    </div>
